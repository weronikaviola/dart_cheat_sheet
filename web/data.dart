...
Map getData() {
  var demoData = {
    ...
    'classes': {
      ...
      'initializer list': 'sets instance variables <b>before</b> the constructor body runs:<br><span class="code">Point.fromJson(Map<String, num> json)<br>&nbsp;&nbsp;: x = json[\'x\'] { ...</span><div class="information">The right-hand side of an initializer does not have access to <span class="code">this</span></div>',
